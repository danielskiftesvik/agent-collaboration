...
argument-hint: '--worker <agy|codex|claude|grok|opencode> [--role worker|reviewer] [--apply] [--timeout <seconds>] <brief>'
...
the task and read the target harness's guide (codex/claude/agy/grok/opencode). For a concrete
