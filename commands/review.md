...
argument-hint: '--worker <codex|claude|cursor|grok|agy|opencode> [--surface head|working-tree|diff] [--focus <text>] <diff / what to review>'
...
Any worker (**codex**, **claude**, **cursor**, **grok**, **agy**, or **opencode**) can review — agy uses its
