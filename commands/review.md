...
argument-hint: '--worker <codex|claude|grok|agy|opencode> [--surface head|working-tree|diff] [--focus <text>] <diff / what to review>'
...
Any worker (**codex**, **claude**, **grok**, **agy**, or **opencode**) can review — agy uses its
