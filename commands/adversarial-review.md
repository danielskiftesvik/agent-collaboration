---
description: Get an adversarial ("try to break it") review from another harness (codex, claude, cursor, grok, agy, or opencode) against the current changes
argument-hint: '--worker <codex|claude|cursor|grok|agy|opencode> [--focus <text>] <what to review>'
...
Any worker (**codex**, **claude**, **cursor**, **grok**, **agy**, or **opencode**) can review. Gather the diff to review
